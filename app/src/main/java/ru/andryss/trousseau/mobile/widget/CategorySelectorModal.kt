...
fun CategorySelectorModal(
    ...
    var selected by remember { mutableStateOf(CategoryNode.EMPTY) }
            ...
            Column(
                ...
                if (getCategoryTreeLoading) {
                    ...
                    Button(
                        ...
                        enabled = (selected != CategoryNode.EMPTY)
                    ) {
                        Text("Выбрать")
                    }
                }
    ...
    Column(
        ...
        Row(
            modifier = Modifier
                ...
                .background(
                    color = if (selected == category) Color.LightGray else Color.Transparent
                ),
            ...
            Box(
                ...
                Icon(
                    imageVector = Icons.Default.run {
                        if (!hasChildren) SubdirectoryArrowRight
...
fun CategoryNodePreview() {
    ...
    var selected by remember { mutableStateOf(CategoryNode.EMPTY) }
    val onSelect: (CategoryNode) -> Unit = { selected = it }
